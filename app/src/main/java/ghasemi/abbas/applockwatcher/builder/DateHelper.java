...
public class DateHelper {
    ...
    public static YearMonthDate getCurrentJalaliDate() {
        ...
        Date d = new Date();
        return new YearMonthDate(sc.year,sc.month,sc.strMonth,sc.date,sc.strWeekDay , calendar.get(Calendar.HOUR_OF_DAY),calendar.get(Calendar.MINUTE),calendar.get(Calendar.SECOND));
    }
    ...
    public static class YearMonthDate {
        ...
        public String toString() {
            return getYear() + "-" + getMonth() + "-" + getDate() + " " + getHour() + ":"+getMinutes()+":"+getSecond();
        }
    }
}